...
public class MateriaController {
    ...
    public ResponseEntity<String> concluirMateria(
            @Parameter(description = "ID da matéria a ser concluída", example = "1")
            @PathVariable Long idMateria, HttpServletRequest request){
    ...
    public ResponseEntity<String> ingressarMateria(
            @Parameter(description = "ID da matéria para ingressar", example = "2")
            @PathVariable Long idMateria, HttpServletRequest request){
    ...
    public ResponseEntity<MateriaResponse> findById(
            @Parameter(description = "ID da matéria para buscar", example = "1")
    ...
    public ResponseEntity<List<MateriaResponse>> getPreRequisitos(
            @Parameter(description = "ID da matéria para verificar os pré-requisitos", example = "2")
